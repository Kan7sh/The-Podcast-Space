  ...
  return (
    <SignedIn>
      <div
        ...
        className="home-background grid grid-rows items-center justify-items-center min-h-screen p-8 pb-20 gap-8 sm:p-20 font-[family-name:var(--font-geist-sans)]"
      >
        <GlassNavBar />
        <div className="flex flex-col-reverse lg:flex-row  gap-20 my-26 lg:my-18 justify-center items-center">
          <Card className="bg-[linear-gradient(to_bottom,_#f5f5f5,_#f5f5f5,_#f5f5f5,_#1b3784)] dark:bg-[linear-gradient(to_bottom,_#171717,_#171717,_#171717,_#1b3784)] border-none rounded-3xl py-25 px-8">
            <div className="flex flex-col lg:flex-row gap-10">
              <Image src={HomeMainImg} width={430} alt={"HomeImage"} />
              <div className="flex flex-col gap-8 w-86">
      ...
      <div id="about" className="lg:h-200 bg-[#1c1c1c] p-30">
        <div className="flex flex-col items-center gap-10">
          <div className="text-xl lg:text-3xl w-90 lg:w-auto flex  items-center justify-center font-bold border-amber-700 border-2 p-3 rounded-xl bg-black text-white font-schibsted">
