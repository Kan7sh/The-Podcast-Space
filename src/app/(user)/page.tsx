...
export default function Home() {
  return (
    <SignedIn>
      ...
      >
        <GlassNavBar />
        <div className="flex flex-row gap-20 my-18 justify-center items-center">
          <Card className="bg-[linear-gradient(to_bottom,_#171717,_#171717,_#171717,_#2a0357)] border-none rounded-3xl py-25 px-8">
      ...
      <div id="about" className="h-200 bg-[#1c1c1c] p-30">
        <div className="flex flex-col items-center gap-10">
          ...
          <Card className="bg-[linear-gradient(to_bottom,_#171717,_#171717,_#171717,_#e07404)] border-none rounded-3xl py-12 px-8 w-260 h-120">
